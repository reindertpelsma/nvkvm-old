...
gcc -O0 -g -o /tmp/cup8 /tmp/cup8.c -lcuda 2>&1 | tail -3

echo "=== cup8 (foreground, timeout ${TIMEOUT}s, CUP8_N=${CUP8_N:-2048}) ==="
LD_LIBRARY_PATH=$GUESTLIB CUP8_N=${CUP8_N:-2048} timeout --signal=INT "$TIMEOUT" stdbuf -oL -eL /tmp/cup8
RC=$?
echo "=== cup8 exit rc=$RC (124=timeout/hang) ==="
